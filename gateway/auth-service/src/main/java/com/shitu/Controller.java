...
public class Controller {
    ...
    @PostMapping("/refresh")
    @ResponseBody
    public AuthResponse verify(@RequestParam String refreshToken) {
    ...
    public AuthResponse verify(
        ...
        return AuthResponse.builder().code(success? AuthResponseCode.SUCCESS: AuthResponseCode.USER_NOT_FOUND).build();
    }
}
